...
async def get_single_symbol_data(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to get data for {symbol}: {str(e)}")
...
async def get_batch_market_data(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to get batch market data: {str(e)}")
